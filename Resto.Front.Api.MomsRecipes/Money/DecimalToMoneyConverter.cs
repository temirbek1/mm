...
namespace Resto.Front.Api.MomsRecipes
{
    ...
    {
        /// <summary>
        /// Format sum as numbers and currency symbol.
        /// </summary>
        NumberAndCurrency,

        /// <summary>
        /// Format sum as numbers only.
        /// </summary>
        NumbersOnly
    }
    ...
    public sealed class DecimalToMoneyConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var numberFormatInfo = MomsRecipesPlugin.CurrencySettings.FormatInfo;
            var format = !MomsRecipesPlugin.CurrencySettings.ShowFractionalPart ? "c0" : "c";
            var sum = MoneyRound(System.Convert.ToDecimal(value), numberFormatInfo.CurrencyDecimalDigits, MomsRecipesPlugin.CurrencySettings.MinimumDenomination);
        ...
        public static decimal MoneyRound(decimal sum, int decimals, decimal minimumDenomination)
        {
